...
extern const u8	  tetris_cheer_pcm[];
extern const u32	tetris_cheer_pcm_size;

extern const u8	  heartbeat_pcm[];
extern const u32	heartbeat_pcm_size;

extern const u8	  powerup_default_pcm[];
extern const u32	powerup_default_pcm_size;

extern const u8	  powerup_invalid_target_pcm[];
extern const u32	powerup_invalid_target_pcm_size;

// powerup image declarations go here
...
extern const u8	  powerup_bighand_pcm[];
extern const u32	powerup_bighand_pcm_size;

extern const u8	  powerup_shrinkray_pcm[];
extern const u32	powerup_shrinkray_pcm_size;
