...
/** @file PowerupMirror.h
 * @author Cale Scholl
 *
 * @page poweruplistpage Powerup List
 *
 * @section PowerupMirror
 * A defensive powerup that reflects powerup attacks.
 */

#pragma once
#ifndef __POWERUPMIRROR_H__
#define __POWERUPMIRROR_H__
